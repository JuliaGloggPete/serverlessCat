...
// felhantering finns det redan??
// om -> return false {success: false, message: 'username alredy exists'}

//npm install bcrypt - crypterings installering
//npm install nanoid  - unique id - kolla i package json på dependencies så ligger altl där ju

const hashedPassword = await bcrypt.hash(password, 10);
//10 är salt? - nåt som säkerställer att vi gör det mer säkert
